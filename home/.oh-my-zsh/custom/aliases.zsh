...
if [[ "$OSTYPE" = darwin* ]]; then
	alias update='sudo softwareupdate -i -a; brew update; brew upgrade; brew cleanup; brew upgrade brew-cask; brew cask cleanup; sudo gem update --system; sudo gem update; sudo gem cleanup'
else
